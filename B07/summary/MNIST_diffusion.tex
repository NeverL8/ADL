...
\author{Simon Barysch}
\title{Diffusion: Generation of MNIST digits}
\date{June 23, 2026}
\birthplace{Dortmund}
\chair{Advanced Deep Learning Course}
\division{Department of Physics}
\thesisclass{Master of Science}
% \submissiondate{June 16, 2026}
% \firstcorrector{Prof.~Dr.~Matthias Schneider}
% \secondcorrector{Prof.~Dr.~Michelle Sander}

% tu logo on top of the titlepage
\titlehead{\includegraphics[height=1.4cm]{../../tu-logo.pdf}}%\hfill
%\includegraphics[height=1.4cm]{logos/BU_logo.png}}
